...
class ShopCategory extends Model
{
    ...
    public function products()
    {
     ...
     public function childs() {
         return $this->hasMany(ShopCategory::class,'parent','id') ;
     }
 ...
 */
    ...
    {
       return $this->where('status', 1)->where('parent', 0)->orderBy('sort', 'ASC')->get();
    }
 ...
 */
    ...
    public function getMenuCats($parent = 0, &$tree = null, $categories = null, &$st = '')
    {
        $categories = $categories ?? $this->getCategoriesAll();
        $tree = $tree ?? [];
        $lisCategory = $categories[$parent] ?? [];
