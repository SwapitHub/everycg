 ...
 */
    ...
    public static function vendorOrders($id)
    {  
        return  $orders = DB::table('shop_order')->select('*')->join('shop_order_detail', 'shop_order_detail.order_id', '=', 'shop_order.id')->where('shop_order_detail.adminid','=', $id)->groupBy('shop_order_detail.order_id')->get();      
     
    }

    public static function vendorGroupOrder($id)
    {  
        return  $orders = DB::table('shop_order')->select('*')->join('shop_order_detail', 'shop_order_detail.order_id', '=', 'shop_order.id')->where('shop_order_detail.adminid','=', $id)->groupBy('shop_order.status')->get();      
