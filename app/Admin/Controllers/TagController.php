       ...
       $data = [
        ...
        foreach ($dataTmp as $key => $row) {           
            $dataTr[] = [
                ...
                'sort' => $row['sort'],
                'action' => '
                    <a href="' . route('admin_tag.edit', ['id' => $row['id']]) . '"><span title="' . trans('edit') . '" type="button" class="btn btn-flat btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
...
//menu_right
        $data['menu_right'] = '
                        <div class="btn-group pull-right" style="margin-right: 10px">
                           <a href="' . route('admin_tag.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
...
//menu_sort
      ...
      var url = '" . route('admin_tag.index') . "?sort_order='+$('#order_sort option:selected').val();
...
//=menu_search
        ...
        $data['url_delete_item'] = route('admin_tag.delete');
 ...
 */
    public function postCreate()
    {
        ...
        return redirect()->route('admin_tag.index')->with('success', 'New Tag created successfully!');
 ...
 */
    public function edit($id)
    {
        ...
        $data = [
            ...
            'tag' => $tag,
            'url_action' => route('admin_tag.edit', ['id' => $tag['id']]),
        ];
        return view('admin.screen.tag')
            ->with($data);
    }
...
//
        return redirect()->route('admin_tag.index')->with('success', trans('Tag updated successfully!'));
