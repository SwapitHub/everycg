       ...
       $data = [
        ...
        foreach ($dataTmp as $key => $row) {  
            $dataTr[] = [
                ...
                'sort' => $row['sort'],
                'action' => '
                    <a href="' . route('admin_widget.edit', ['id' => $row['id']]) . '"><span title="' . trans('banner.widget.edit') . '" type="button" class="btn btn-flat btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
...
//menu_right
        $data['menu_right'] = '
                        <div class="btn-group pull-right" style="margin-right: 10px">
                           <a href="' . route('admin_widget.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
 ...
 */
    public function create()
    {
        $data = [
            ...
            'widget' => [],
            'url_action' => route('admin_widget.create'),
        ];
 ...
 */
    public function postCreate()
    {
        ...
        return redirect()->route('admin_widget.index')->with('success', 'Widget created successfully!');
    }
/**
 * Form edit
 */
    public function edit($id)
    {
        ...
        $data = [
            ...
            'languages' => $this->languages,
            'widget' => $widget,
            'url_action' => route('admin_widget.edit', ['id' => $widget['id']]),
        ];
        return view('admin.screen.widget')
            ->with($data);
    }
...
//Edit
        ...
        return redirect()->route('admin_widget.index')->with('success', 'Widget updated successfully!');
    }
/*
Delete list Item
