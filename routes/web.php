...
// Track email open
Route::get('/email/open/rate/{list_id}', [EmailTrackingController::class, 'getOpenRate'])->name('track.open.rate');
Route::get('/track/email/open', [EmailTrackingController::class, 'track'])->name('track.email.open');
