        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">  
            ...
            <?php } else { ?>
              ...
              <div class="pull-right">
               <a href="{{ route('logout') }}" class="btn btn-default btn-flat" rel="nofollow" onclick="event.preventDefault();  document.getElementById('logout-form').submit();">{{ trans('admin.logout') }}</a>
                </div>
            <?php } ?>
            </li>
          </ul>
