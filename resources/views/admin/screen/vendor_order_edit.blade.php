          ...
          <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php $prod = App\Models\ShopProduct::find($item->product_id); 
                    if($prod->adminid==$userid->id) { ?>
                          <tr>
                            <td>{{ $item->name }}
                              @php
                              $html = '';
                ...
                <table   class="table table-bordered">
                  @foreach ($dataTotal as $element)                  
                     ...
                     @if ($element['code'] =='total')
                      <tr style="background:#f5f3f3;font-weight: bold;"><td>{!! $element['title'] !!}:</td><td style="text-align:right" class="data-{{ $element['code'] }}">{{ sc_currency_format($ttl['totalprice']) }}</td></tr>
                    @endif
