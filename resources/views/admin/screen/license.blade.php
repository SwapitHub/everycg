            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <div class="btn-group pull-right" style="margin-right: 5px">
                        <a href="{{ route('admin_license.index') }}" class="btn  btn-flat btn-default" title="List"><i
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" style="width: 100px;" id="sort" name="sort"
                                        value="{!! old()?old('sort'):$license['sort']??0 !!}" class="form-control sort"
                                        placeholder="" />
                                </div>
                                @if ($errors->has('sort'))
                                <span class="help-block">
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" name="status"
                                    {{ old('status',(empty($license['status'])?0:1))?'checked':''}}>
