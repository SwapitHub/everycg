                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group   {{ $errors->has('first_name') ? ' has-error' : '' }}">
                                <label for="first_name" class="col-sm-2  control-label">Contact List Name</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group {{ $errors->has('email_content') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="email_content" class="editor" name="email_content">
                                        {!! old('email_content', $customer['email_content'] ?? '') !!}
                                    </textarea>
