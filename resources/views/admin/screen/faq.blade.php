            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <div class="btn-group pull-right" style="margin-right: 5px">
                        <a href="{{ route('admin_faq.index') }}" class="btn  btn-flat btn-default" title="List"><i
                ...
                <div class="box-body">
                    <div class="fields-group">        
                        ...
                        <div class="form-group   {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name"
                                class="col-sm-2  control-label">Question<span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="alias" name="alias"
                                        value="{!! old('alias',($faq['alias']??'')) !!}" class="form-control"
                                        placeholder="" />
                                </div>
                                @if ($errors->has('alias'))
                                <span class="help-block">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" style="width: 100px;" id="sort" name="sort"
                                        value="{!! old()?old('sort'):$faq['sort']??0 !!}" class="form-control sort"
                                        placeholder="" />
                                </div>
                                @if ($errors->has('sort'))
                                <span class="help-block">
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" name="status"
                                    {{ old('status',(empty($faq['status'])?0:1))?'checked':''}}>
                            </div>
                        </div>
