            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    <div class="btn-group pull-right" style="margin-right: 5px">
                        <a href="{{ route('admin_suser.index') }}" class="btn  btn-flat btn-default" title="List"><i
                        ...
                        <hr>
                         ...
                         <div class="form-group   {{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" id="email" name="email" value="{!! old('email',($seller['email']??'')) !!}"
                                        class="form-control email" placeholder="" readonly />
                                </div>
                                @if ($errors->has('email'))
                                <span class="help-block">
                                    {{ $errors->first('email') }}
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" name="status"
                                    {{ old('status',(empty($seller['user_verify'])?0:1))?'checked':''}}>
