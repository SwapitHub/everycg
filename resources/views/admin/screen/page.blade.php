        ...
        <div class="box">
            ...
            <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"
                ...
                <div class="box-body">
				   ...
				   <div class="form-group   {{ $errors->has('descriptions.'.$code.'.meta_title') ? ' has-error' : '' }}">
                            <label for="{{ $code }}__meta_title"
                                class="col-sm-2  control-label">Meta Title <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" id="{{ $code }}__meta_title" name="meta_title"
                                        value="{!! old('descriptions.'.$code.'.meta_title',($descriptions[$code]['meta_title']??'')) !!}"
                                        class="form-control {{ $code.'__meta_title' }}" placeholder="" />
                                </div>
                                @if ($errors->has('descriptions.'.$code.'.meta_title'))
                                <span class="help-block">
                                    {{ $errors->first('descriptions.'.$code.'.meta_title') }}
                                </span>
                                @endif
                            </div>
                        </div>
						<div class="form-group   {{ $errors->has('descriptions.'.$code.'.meta_keyword') ? ' has-error' : '' }}">
                            <label for="{{ $code }}__meta_keywork"
                                class="col-sm-2  control-label">Meta Keywork <span class="seo" title="SEO"><i class="fa fa-coffee" aria-hidden="true"></i></span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" id="{{ $code }}__meta_keywork" name="meta_keyword"
                                        value="{!! old('descriptions.'.$code.'.meta_keyword',($descriptions[$code]['meta_keyword']??'')) !!}"
                                        class="form-control {{ $code.'__meta_keywork' }}" placeholder="" />
                                </div>
						...
						<div class="form-group   {{ $errors->has('descriptions.'.$code.'.meta_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" id="{{ $code }}__meta_description" name="meta_description"
                                        value="{!! old('descriptions.'.$code.'.meta_description',($descriptions[$code]['meta_description']??'')) !!}"
                                        class="form-control {{ $code.'__meta_description' }}" placeholder="" />
                                </div>
