  ...
  */
    ...
    <div class="container width_int">
        <div class="loader-div">
            ...
            <div class="row ">
                @if (count($products) == 0)
                    <div class="search_page_ans">
                        <h4><strong>No Product</strong></h4>
                    </div>
                @else
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <h5 class="card-title">@php
                                            echo strlen($product_new->name) > 20
                                                ? substr($product_new->name, 0, 20) . '..'
                                                : $product_new->name;
                                        @endphp </h5>
                                        @if ($product_new->stock == 0)
                                            <!--<div class="list-stock">
                 <?php if ($product_new->stock == 0) {
                     echo 'Out of stock';
                 } ?>
                </div>--->
                                        @endif
