                        ...
                        <div class="form-group">
                                  <div>
                                    <label class="radio-inline">
                                        <?php  if($paymentMethodData['title']=='stripe'){ ?>
                                            <img title="{{ $paymentMethodData['title'] }}" alt="{{ $paymentMethodData['title'] }}" src="{{ asset('/images/mastercard.png') }}" style="width: 120px;">
                                            <?php }
                                            elseif($paymentMethodData['title']=='Cash on delivery') { echo '<img src="'.asset('images/free.png').'" title="Free" alt="Free" style="width: 120px;">'; }  else { ?> 
